...
int main(int , char* [])
{
  ...
  std::vector<size_type> perm(num_vertices(G));
  {
    ...
    BOOST_TEST_EQ(9, index_map[inv_perm[1]]);
    BOOST_TEST_EQ(2, index_map[inv_perm[2]]);
    BOOST_TEST_EQ(3, index_map[inv_perm[3]]);
    BOOST_TEST_EQ(0, index_map[inv_perm[4]]);
    BOOST_TEST_EQ(1, index_map[inv_perm[5]]);
...

  {
    ...
    BOOST_TEST_EQ(8, index_map[inv_perm[0]]);
    BOOST_TEST_EQ(0, index_map[inv_perm[1]]);
